...
Saving/loading:
Saving can be done whenever a player is given the option to move around the dungeon i.e. 1. 2. 3. 4. NSEW. typing 5 however will pull up the menu and
...
In game menu: click 5 when given an option to move
...
Escape: There is a 10% chance in escaping. Upon success, monster dissappears and player returns to an empty tile however, it is advised players fight every monster they can as they have a chance to drop items that can benefit the player. There is no turn penalty to choosing escape as this game is meant to be beginner friendly
